    ...
    def overlay(
        ...
        if (tracking is not None):
            ...
            for idx, id in zip(tracking.animals.indices, tracking.animals.identities):
                ...
                tx_bbox = tracking.animals.bounding_boxes[idx,0] - tracking.animals.padding[idx,0]
                ty_bbox = tracking.animals.bounding_boxes[idx,1] - tracking.animals.padding[idx,1]
